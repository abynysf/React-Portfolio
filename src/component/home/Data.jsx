...
const Data = () => {
    return (
        <div className="home_data">
            <h1 className="home_title">Muhammad Abyan Farras Yusuf
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <ul className="dynamic-txt">
              <li><span>Aspiring Software Engineer</span></li>
              <li><span>Aspiring Full Stack</span></li>
              <li><span>Still Jomblo</span></li>
              <li><span>Not A Weaboo!!!</span></li>
            </ul>
            </h3>
            <p className="home_description">As a full stack developer with a passion for creating beautiful and interactive website.</p>
