                ...
                <div className="contact_content">
                    ...
                    <div className="contact_info">
                        <div className="contact_card">
                            ...
                            <span className="contact_card-data">abyanyusuf07@gmail.com</span>

                            <a href="mailto:abyanyusuf07@gmail.com" target="_blank" className="contact_button">Write me<i className="bx bx-right-arrow-alt contact_button-icon"></i>
                            </a>
                        </div>
                        ...
                        <div className="contact_card">
                            ...
                            <span className="contact_card-data">+62-85336240351</span>

                            <a href="https://api.whatsapp.com/send?phone=6286336240351&text=Hello, Abyan!" target="_blank" className="contact_button">Write me 
                        ...
                        <div className="contact_card">
                            ...
                            <a href="tel:85336240351" target="_blank" className="contact_button">Call me 
                            <i className="bx bx-right-arrow-alt contact_button-icon"></i>
                            </a>
                        </div>
                    </div>
