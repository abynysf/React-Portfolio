                ...
                <div className="qualification_sections">
                    <div className={
                        ...
                        <div className="qualification_data">
                            <div>
                                <h3 className="qualification_title">Applied Undergraduate of Software Engineering </h3>
                                <span className="qualification_subtitle">Universitas Gadjah Mada</span>
                        ...
                        <div className="special"></div>
                            ...
                            <div>
                                <h3 className="qualification_title">High School Diploma in Mathematics and Natural Science</h3>
                                <span className="qualification_subtitle">SMA Negeri 4 Kendari</span>
